  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="text-center space-y-2">
        ...
        <CardTitle className="text-lg pt-2">Welcome back</CardTitle>
        <CardDescription className="text-[var(--text-muted)]">
      ...
      <CardContent>
        ...
        <div className="mt-4">
          <Button
            variant="outline"
            className="w-full border-border text-[var(--text-secondary)] hover:text-foreground"
            onClick={handleMagicLink}
            disabled={loading}
          >
            Send Magic Link
        ...
        <div className="relative my-6">
          <Separator />
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-card px-3 text-xs text-[var(--text-muted)]">
            or
          </span>
        </div>
